...
public class excel_utility {
	...
	{
		FileInputStream fis=new FileInputStream("./src/main/resources/property file/Book20.xlsx");
	...
	public void setDataIntoExcel(String sheetname,int rownum,int cellnum,String data) throws EncryptedDocumentException, IOException
	{
		...
		FileOutputStream fos=new FileOutputStream("./src/main/resources/property file/Book20.xlsx");
		wb.write(fos);
		wb.close();
